...
def get_gemini_response(prompt):
    condition = prompt.split("for")[-1].strip().replace(".", "").capitalize()
    ...
    remedies_dict = {
        "Acne": [
            ...
            "Do not touch or pick acne to prevent scars",
        ...
        "Eczema": [
            ...
            "Wear soft cotton clothes instead of synthetic fabrics",
            "Avoid allergens that trigger irritation",
            "Use prescribed creams if condition worsens"
        ],
        "Keratosis": [
            "Use creams containing urea or lactic acid for exfoliation",
            "Moisturize your skin daily to reduce dryness",
            "Avoid harsh scrubbing which can worsen the condition",
            "Take short and warm showers instead of hot ones",
            "Use gentle and hydrating skincare products",
            "Apply mild exfoliants to smooth the skin"
        ],
        "Rosacea": [
            "Avoid spicy foods, alcohol, and caffeine",
            "Use sunscreen daily to protect skin",
            "Use gentle and non-irritating skincare products",
            "Avoid extreme temperatures and sun exposure",
            "Reduce stress which can trigger flare-ups",
            "Consult a dermatologist for medical creams"
        ],
        "Milia": [
            "Avoid heavy creams and oily products",
            "Use gentle exfoliation to prevent buildup",
            "Do not squeeze or pick milia",
            "Keep your skin clean and hydrated",
            "Use retinol-based creams if recommended",
            "Consult a dermatologist for safe removal"
        ],
        "Carcinoma": [
            "Consult a dermatologist immediately for diagnosis",
            "Avoid prolonged sun exposure",
            "Use sunscreen with high SPF regularly",
            "Monitor any changes in skin lesions",
            "Follow medical advice strictly",
            "Seek early treatment for better outcomes"
        ]
    }

    remedies = remedies_dict.get(condition, [
